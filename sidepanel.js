    ...
    html += `
      <div style="padding: 1.25rem; background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
        <div style="display: flex; gap: 1rem; margin-bottom: 0.75rem;">
          ${resumeDomain ? `<div style="flex: 1; min-width: 0;"><div style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 700; margin-bottom: 0.15rem;">Resume Domain</div><div style="font-size: 0.8125rem; font-weight: 500; color: #475569; background: #fff; padding: 0.4rem 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px; overflow-x: auto; white-space: nowrap;">${resumeDomain}</div></div>` : ''}
          ${jobDomain ? `<div style="flex: 1; min-width: 0;"><div style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 700; margin-bottom: 0.15rem;">Job Domain</div><div style="font-size: 0.8125rem; font-weight: 500; color: #475569; background: #fff; padding: 0.4rem 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px; overflow-x: auto; white-space: nowrap;">${jobDomain}</div></div>` : ''}
        </div>
